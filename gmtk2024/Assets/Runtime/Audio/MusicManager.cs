...
public class MusicManager : MonoSingleton<MusicManager>
{
    ...
    void Start()
    {
        ...
        soundtrackEventDescription.getParameterDescriptionByName("Music progression", out levelParameterDescription);
        _LevelParameter = levelParameterDescription.id;
        SoundtrackInstance.setParameterByID(_LevelParameter, 4);

        GameManager.Instance.LevelManager.FinishedLevel += () => SetMusicLevel(GameManager.Instance.LevelManager.Level);
    }
