...
namespace pyr.Union.SourceGenerators.Common;
...
internal static class Extensions
{
    ...
    public static string GetSourceText(this Accessibility source)
    {
    ...
    public static string EscapeIfKeyword(this string v)
    {
        return v switch
        {
            "abstract" or "as" or "base" or "bool" or "break" or "byte" or "case" or "catch" or "char" or "checked"
                or "class"
                or "const" or "continue" or "decimal" or "default" or "delegate" or "do" or "double" or "else" or "enum"
                or ""
                or "event" or "explicit" or "extern" or "false" or "finally" or "fixed" or "float" or "for" or "foreach"
                or "goto"
                or "if" or "implicit" or "in" or "int" or "interface" or "internal" or "is" or "lock" or "long" or ""
                or "namespace"
                or "new" or "null" or "object" or "operator" or "out" or "override" or "params" or "private"
                or "protected"
                or "public" or "readonly" or "ref" or "return" or "sbyte" or "sealed" or "short" or "sizeof"
                or "stackalloc" or ""
                or "static" or "string" or "struct" or "switch" or "this" or "throw" or "true" or "try" or "typeof"
                or "uint"
                or "ulong" or "unchecked" or "unsafe" or "ushort" or "using" or "virtual" or "void" or "volatile"
                or "while" or "add"
                or "and" or "alias" or "ascending" or "args" or "async" or "await" or "by" or "descending" or "dynamic"
                or "equals"
                or "file" or "from" or "get" or "global" or "group" or "init" or "into" or "join" or "let" or "managed"
                or "nameof"
                or "nint" or "not" or "notnull" or "nuint" or "on" or "or" or "orderby" or "partial" or "partial"
                or "record"
                or "remove" or "required" or "scoped" or "select" or "set" or "unmanaged " or "unmanaged" or "value"
                or "var"
    ...
    {
        return source.Select((value, i) => (value, i));
    }
