...
public static unsafe class NativeCollectionExtensions
{
    ...
    /// <typeparam name="T">An unmanaged type</typeparam>
    /// <returns>
    ///     The 0 based index of the element or a negative number that is th bitwise complement of the index of
    ///     the next largest element. This can be used to find an insertion point for elements not in the array.
    /// </returns>
        ...
        where T : unmanaged, IComparable<T>
    {
        ...
        return NativeCollectionUnsafe.BinarySearch(
    ...
    private static void CheckInRangeOrThrow(int startIndex, int count, int length)
    {
