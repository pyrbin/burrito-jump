...
internal sealed class PriorityQueueDebugView<TElement, TPriority>
{
    ...
    {
        ArgumentNullExceptionHelper.ThrowIfNull(queue);
...
public class PriorityQueue<TElement, TPriority>
{
    ...
    {
        Debug.Assert(Log2Arity > 0 && System.Math.Pow(2, Log2Arity) == Arity);
    }
#endif
    ...
    {
        ArgumentNullExceptionHelper.ThrowIfNull(items);
    ...
    {
        ArgumentNullExceptionHelper.ThrowIfNull(elements);
    ...
    private void Grow(int minCapacity)
    {
        ...
        newcapacity = System.Math.Max(newcapacity, _nodes.Length + MinimumGrow);
    ...
    private void RemoveRootNode()
    {
        ...
        if (RuntimeHelpers.IsReferenceOrContainsReferences<(TElement, TPriority)>()) _nodes[lastNodeIndex] = default;
    }
    ...
    private void MoveDownDefaultComparer((TElement Element, TPriority Priority) node, int nodeIndex)
    {
        ...
        while ((i = GetFirstChildIndex(nodeIndex)) < size)
        {
            ...
            var childIndexUpperBound = System.Math.Min(i + Arity, size);
            ...
            ICollection
    {
        ...
        {
            ArgumentNullExceptionHelper.ThrowIfNull(array);
