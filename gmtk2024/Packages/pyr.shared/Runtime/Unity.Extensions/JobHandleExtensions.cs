...
public static class JobHandleExtensions
{
    ...
    public static JobHandle CombineDependencies(JobHandle handle0, JobHandle handle1, JobHandle handle2, JobHandle handle3, JobHandle handle4, JobHandle handle5, JobHandle handle6, JobHandle handle7, JobHandle handle8, params JobHandle[] handles)
    {
        ...
        return handles.Aggregate(handle, JobHandle.CombineDependencies);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0) { self = CombineDependencies(self, handle0); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1) { self = CombineDependencies(self, handle0, handle1); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1, JobHandle handle2) { self = CombineDependencies(self, handle0, handle1, handle2); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1, JobHandle handle2, JobHandle handle3) { self = CombineDependencies(self, handle0, handle1, handle2, handle3); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1, JobHandle handle2, JobHandle handle3, JobHandle handle4) { self = CombineDependencies(self, handle0, handle1, handle2, handle3, handle4); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1, JobHandle handle2, JobHandle handle3, JobHandle handle4, JobHandle handle5) { self = CombineDependencies(self, handle0, handle1, handle2, handle3, handle4, handle5); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1, JobHandle handle2, JobHandle handle3, JobHandle handle4, JobHandle handle5, JobHandle handle6) { self = CombineDependencies(self, handle0, handle1, handle2, handle3, handle4, handle5, handle6); }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CombineDependencies(ref this JobHandle self, JobHandle handle0, JobHandle handle1, JobHandle handle2, JobHandle handle3, JobHandle handle4, JobHandle handle5, JobHandle handle6, JobHandle handle7) { self = CombineDependencies(self, handle0, handle1, handle2, handle3, handle4, handle5, handle6, handle7); }
}
